const projects = [
...

  {
    ...
    technologies:
      "Built with Flutter, Dart, real-time communication, payment integration, and clean architecture using Cubit for state management.",
    ...
    technologies:
      "Built with Flutter, Dart, real-time system, and structured architecture ensuring secure and scalable experience.",
  ...
  },
  {
    ...
    technologies:
      "Built with Flutter and Dart, integrated with APIs, QR scanning, and chatbot features, following Clean Architecture and using Cubit for state management.",
