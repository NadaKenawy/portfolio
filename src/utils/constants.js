const projects = [
  {
    ...
    src: "public/images/projectsImages/CareNestApp.png",
  ...
  },
{
...
},
  {
    ...
    technologies: "Built with Dart, Flutter, Firebase, using clean code and Cubit for state management.",
    ...
    technologies: "Implemented with Cubit, Dart, Flutter, API, following MVVM pattern, clean code principles, and an attractive UI",
  ...
  },
  {
    ...
    title: "Weather App",
    description:
      "A weather forecasting mobile application that provides real-time weather updates, hourly and weekly forecasts, and location-based data using a clean and user-friendly interface.",
    technologies: "Used Cubit, Dart, Flutter, API, and created an attractive UI",
...

  {
    ...
    technologies: "Built with Dart, Flutter, Firebase Auth, and Firestore for real-time messaging",
